...
const { useEffect, useMemo, useReducer, memo, createContext } = React;
  ...
  switch (action.type) {
    ...
    case OPEN_CELL: {
      ...
      const checkAround = (row, col) => {
        ...
        let count = around.filter((cell) =>
          [CODE.MINE, CODE.QUESTION_MINE, CODE.FLAG_MINE].includes(cell)
        ).length;
