    ...
    render() {
        return (
            <div className='rsp__wrap'>
                ...
                <div>
                    <button id="rock" className="button" onClick={this.onClickBtn}>바위</button>
                    <button id="scissor" className="button" onClick={this.onClickBtn}>가위</button>
                    <button id="paper" className="button" onClick={this.onClickBtn}>보</button>
                </div>
